import { SharedElementNode, SharedElementEventSubscription, SharedElementSceneComponent, SharedElementAnimatedValue, NavigationProp } from "./types";
...
export default class SharedElementSceneData {
    ...
    constructor(Component: SharedElementSceneComponent, navigation: NavigationProp, navigatorId: string, nestingDepth: number, debug: boolean);
